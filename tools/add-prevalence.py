...
COMMON = {
    ...
    "armillaria_mellea", "armillaria_tabescens", "auricularia_americana",
...
OCCASIONAL = {
    ...
    "calvatia_craniiformis", "cerioporus_squamosus", "clitocybe_gibba",
    "clitocybe_nuda", "cortinarius_alboviolaceus", "cystoderma_amianthinum",
    "entoloma_abortivum", "hericium_erinaceus", "hydnum_repandum",
    "hygrocybe_conica", "hygrophoropsis_aurantiaca", "hymenopellis_radicata",
    "hypomyces_lactifluorum", "inocybe_rimosa", "lactarius_indigo",
...
SOUGHT = {
    ...
    "cerioporus_squamosus", "clitocybe_nuda", "coprinus_comatus",
